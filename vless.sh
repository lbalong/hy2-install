...
echo "=========================================================="
echo "      VLESS + Reality 纯净 IP 满血完全体 (固化 sd 查询)"
echo "=========================================================="
...
# 4. 持久化保存本次端口，供下次运行自动检测
echo "LAST_PORT=\"$PORT\"" > "$CONFIG_FILE"

# 5. 核心速度黑科技：BBR + 16MB 巨型缓冲区 + TCP Fast Open
...
echo "=========================================="
echo " 📋 您当前激活的 VLESS-Reality 配置单 (纯 IP 版)"
echo "=========================================="
echo " 端口 (Port): $PORT"
echo "=========================================="
echo "👇 您的一键导入链接（纯 IP 测速不报错版）："
